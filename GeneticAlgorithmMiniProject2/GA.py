...
class GARunner:
    ...
    def SetPreferences(self, population_Size, mutation_Rate, crossover_Points,  crossover_rate, generations, run_GA):
...
##        print('Population.List: \n'+ self.GA.Population.ToString('   ', ' '))
    ...
    def main(self, population_Size, mutation_Rate, crossover_Points,  crossover_rate, generations, run_GA):
        print('This is method', population_Size, mutation_Rate, crossover_Points,  crossover_rate, generations, run_GA)
        self.SetPreferences(population_Size, mutation_Rate, crossover_Points,  crossover_rate, generations, run_GA)
##        OutputFile = open( self.OutputFileName , 'a')
...
##        OutputFile.close()
        ...
        while self.RunCount < self.NumberOfTimesToRun:            
            ...
            self.GA.Run()
            result.append(self.PrintRunResults())
...
#GARunner = GARunner()
#GARunner.main(population_Size, mutation_Rate, crossover_Points,  crossover_rate, generations, run_GA)
